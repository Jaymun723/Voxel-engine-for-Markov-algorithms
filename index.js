...
Module['FS_createPath']("/shaders", "single_color", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/.keep", "start": 0, "end": 0}, {"filename": "/assets/illustration.jpg", "start": 0, "end": 207640}, {"filename": "/assets/img.png", "start": 207640, "end": 412622}, {"filename": "/assets/skybox_01.png", "start": 412622, "end": 2338947}, {"filename": "/shaders/mesh/mesh.frag.glsl", "start": 2338947, "end": 2343382}, {"filename": "/shaders/mesh/mesh.vert.glsl", "start": 2343382, "end": 2345239}, {"filename": "/shaders/single_color/single_color.frag.glsl", "start": 2345239, "end": 2345407}, {"filename": "/shaders/single_color/single_color.vert.glsl", "start": 2345407, "end": 2345624}], "remote_package_size": 2345624});

  })();

// end include: /tmp/tmp716bkzjy.js
// include: /tmp/tmpwjwp48nt.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpwjwp48nt.js
// include: /tmp/tmpdby9agx5.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpdby9agx5.js
...
var ASM_CONSTS = {
  145888: () => { return document.getElementById('canvas').width; },  
 145940: () => { return document.getElementById('canvas').height; },  
 145993: () => { return document.getElementById('canvas').width; }
};
