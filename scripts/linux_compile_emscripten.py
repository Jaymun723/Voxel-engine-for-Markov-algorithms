...
os.system(f"cd {basedir}; cd ..; rm -f Makefile_emscripten")
print("\n=========================================================================")
print(
    "If the compilation succeed, run the following command in the root directory to test the webpage:"
)
print("$ emrun out/index.html")
